  ...
  return (
    ...
    >
      <button
        ...
        className="flex w-full items-center justify-between gap-2 px-4 py-3 text-left text-ds-body-sm font-medium text-ds-text hover:bg-ds-surface-hover transition-colors"
          ...
          {scalingOptions.map((option, i) => (
            <li key={i}>
              <button
                type="button"
                onClick={() => toggle(i)}
                className={`flex w-full items-start gap-3 px-4 py-3 text-left text-ds-body-sm transition-colors ${
                  isSelected(i)
                    ? "bg-ds-accent/10 text-ds-text border-l-2 border-ds-accent"
              ...
              >
                <span
                  className={`mt-0.5 flex h-5 w-5 shrink-0 items-center justify-center rounded border ${
                    isSelected(i)
                      ? "border-ds-accent bg-ds-accent text-ds-bg"
